...
class Admin extends Main
{
    ...
    public function drawTheme($file)
    {
        ...
        $this->assign['vedika_access'] = ($access == 'all') || in_array('vedika', explode(',', $access)) ? true : false;
        $this->assign['module_vedika'] = $this->db('mlite_modules')->where('dir', 'vedika')->oneArray();
